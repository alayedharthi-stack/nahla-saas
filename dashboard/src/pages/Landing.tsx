...
export default function Landing() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-slate-900 overflow-x-hidden" style={{ fontFamily: "'Cairo', sans-serif" }}>
      ...
      <section
        ref={heroRef}
        className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-[#0f1d2e] to-slate-900 pt-16 pb-56 sm:pb-0"
      >
        <HoneycombBg />
        {/* Glow */}
