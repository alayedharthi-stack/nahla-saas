...
// NOTE: This is a *condensed* upgrade-prompt highlight list, not the full
// pricing-card feature list. The full list lives in the backend seed
// (BILLING_PLANS_SEED) and is delivered via GET /billing/plans. The first
// item MUST stay the killer feature in sync with the seed.
const PLAN_HIGHLIGHTS: Record<PlanSlug, string[]> = {
  ...
  growth: [
    ...
    '🛍️ مزامنة كتالوج Meta و Google و YouTube و TikTok (قريبًا)',
    '💬 حتى 15,000 محادثة شهريًا',
  ],
  scale: [
    '📱 واتساب الأعمال على الجوال + الذكاء الاصطناعي + الحملات معًا',
    '✈️ الطيار الآلي الكامل للمبيعات والردود وخدمة العملاء',
    '♾️ محادثات وحملات غير محدودة',
    '👥 فرق عمل متعددة وصلاحيات متقدمة',
    '🔌 API كامل وربط مخصص',
    '⚡ أولوية قصوى في سرعة الذكاء',
