...
export const AI_SALES_PERMISSION_META: Array<{
...
}> = [
  {
    ...
    hint:  'تعرض نحلة منتجات مقترحة بناءً على استفسار العميل',
    icon:  '⭐',
  },
  {
    key:   'allow_order_creation',
    label: 'السماح بإنشاء الطلبات',
    hint:  'تنشئ نحلة مسودة طلب مباشرةً من المحادثة',
    icon:  '🛍️',
  },
  {
    key:   'allow_address_collection',
    label: 'السماح بجمع العنوان',
    hint:  'تطلب نحلة المدينة والعنوان من العميل عند الحاجة',
    icon:  '📍',
  },
  {
    key:   'allow_payment_link_sending',
    label: 'السماح بإرسال روابط الدفع',
    hint:  'ترسل نحلة رابط دفع إلكتروني للعميل عند اختياره',
    icon:  '💳',
  },
  {
    key:   'allow_cod_confirmation_flow',
    label: 'السماح بالدفع عند الاستلام',
    hint:  'تنشئ نحلة طلبات COD وتُشغّل تدفق تأكيد الطيار التلقائي',
    icon:  '💵',
  },
  {
    key:   'allow_human_handoff',
    label: 'السماح بالتحويل لموظف',
    hint:  'تحوّل نحلة المحادثة لموظف بشري عند انخفاض الثقة أو طلب العميل',
    icon:  '👤',
  },
]
