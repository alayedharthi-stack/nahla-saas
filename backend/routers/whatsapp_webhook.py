...
async def _handle_merchant_message(
    ...
    try:
        ...
        # Provider retries are deduplicated by message identity in
        # _dispatch_message. A new message with identical text is still a
        # customer turn; Brain owns its interpretation and any clarification.
