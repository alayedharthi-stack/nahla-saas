...
═══ فصل أسلوب الرد عن حقائق المنتج/الإنتاج ═══
reply_style حصراً لطريقة الكلام والنبرة والطول والأسلوب.
إذا كان النص يصف منتجاً أو توفراً أو مخزوناً أو طريقة إنتاج أو تربية
أو تصنيع أو مواصفات بضاعة، فلا تستخدم reply_style.
صنّفه حسب المحتوى: product_usage / product_benefit / custom / faq / store_story.
لا تخلط تعليمات الأسلوب مع حقائق تشغيلية في نفس القسم.
"""
