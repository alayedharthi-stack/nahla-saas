...
SALES_BEHAVIOR_EXAMPLES: tuple[tuple[str, str, str, str], ...] = (
    # ── #1: types + prices dump (generic apparel merchant) ───────────────
    (
        "وش الأنواع وأسعارها",
        (
            "عندنا حالياً ثلاثة خيارات\n"
            "حذاء رياضي أبيض: مقاس 40 بـ 199 — مقاس 42 بـ 219 — مقاس 44 بـ 239\n"
            "حذاء كاجوال بني: مقاس 41 بـ 179 — مقاس 43 بـ 189\n"
            "صندل صيفي: مقاس 40 بـ 99 — مقاس 42 بـ 109\n"
            "أي نوع يهمك أكثر؟"
        ),
        (
            "عندنا حالياً ثلاثة خيارات\n"
            ...
            "• حذاء كاجوال بني\n"
            "• صندل صيفي\n\n"
            "تحب الرياضي للاستخدام اليومي ولا الكاجوال للخروجات؟"
        ),
        "أسماء فقط في أول رد + سؤال توجيه. السعر والأحجام تأتي بعد ما يحدّد.",
    ),
    # ── #2: compare two products — no full table ──────────────────────
    (
        "الفرق بين العطر الوردي والعطر الخشبي",
        (
            "عطر ورد 100ml ناعم وخفيف، مناسب للنهار، "
            "ربع 89 — نص 149 — كامل 249.\n"
            "عطر خشب 100ml أعمق وأثقل، مناسب للمساء، "
            "ربع 99 — نص 169 — كامل 279.\n"
    ...
    (
        "أبي شكل القميص الأزرق",
        (
            "تفضل صورة قميص قطني أزرق\n"
            "[PRODUCT:قميص قطني أزرق]\n\n"
            "هذا القميص قطن 100%، مناسب للصيف، متوفر بمقاس M بـ 129 "
            "و L بـ 139 و XL بـ 149. تبي أرسل لك الرابط؟"
        ),
        (
            "[PRODUCT:قميص قطني أزرق]"
        ),
...
BASELINE_POLICY_RULES: tuple[str, ...] = (
    ...
    # Natural-product tone — confident without medical claims (category-agnostic).
    "عند الحديث عن المنتجات الطبيعية أو الغذائية أو التجميلية: تحدّثي بثقة وأسلوب محترم بدون تشخيص طبي أو وعود قطعية بالشفاء — يُفضّل صياغات مثل (بإذن الله فيه خير / حسب تجارب كثير من عملائنا / كثير من الناس يهتمّون به). تجنّبي الجمل الباردة التي تُقلل من قيمة المنتج أو تُحوّل الحديث إلى نبرة طبية جافة.",
