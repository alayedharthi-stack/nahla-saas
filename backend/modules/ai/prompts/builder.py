...
def build_system_prompt(ctx: Dict[str, Any]) -> str:
    ...
    sections.append(
        ...
        "  • [قاعدة صارمة للكوبونات] لا تذكر الكوبونات أو أكوادها أبداً إلا في "
        "حالة واحدة فقط: أن يُبدي العميل صراحةً تردداً في السعر أو يطلب منك خصماً. "
        "لا ترسل قائمة الكوبونات في الترحيب ولا عند الإجابة على أسئلة المنتجات "
        "ولا عند إنشاء الطلب — لأن ذلك يُضعف قيمة المتجر ويُشتت العميل.\n"
