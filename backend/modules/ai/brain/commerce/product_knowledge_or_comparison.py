...
# Public store facts from knowledge_section_kinds. Keep assistant behavior
# (including the older reply_style/dialect kinds) out of factual evidence.
_MERCHANT_OPERATIONAL_KB_KINDS = frozenset({
