...
# Competitor context — «عند» / «عندكم» availability phrasing is intentionally excluded.
...
def _has_price_objection_signals(norm: str) -> bool:
    ...
    return has_competitor and (has_price or has_comparison)
