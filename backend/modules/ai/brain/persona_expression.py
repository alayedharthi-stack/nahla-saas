...
def compose_social_persona_goal(social_category: str) -> str:
    ...
    return (
        ...
        "for pure social reciprocals, one short natural acknowledgement is "
        "enough — do not ask a follow-up question unless the customer asked "
        "for help or opened a real topic; do not append greeting or status "
        "questions; do not turn a reciprocal into a customer-care turn; "
        "do not stack multiple prayers or duas; match the customer's "
