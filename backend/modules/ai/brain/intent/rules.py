...
_register(RuleSet(
    ...
    patterns=[
        ...
        r"(أبغى|أريد|أبي|بدي|ودي|بغيت|اشتري|شراء|طلب(?!ات)).{0,40}",
...
_register(RuleSet(
    ...
    patterns=[
        ...
        r"(متى يوصل الطلب|متى توصل الطلب|متى توصل الطلبية|متى يجي الطلب|متى تشحنون|متى يتم الشحن)",
...
_register(RuleSet(
    ...
    patterns=[
        ...
        r"((?:ارسل|أرسل|ارسلي|أرسلي|ابعث|أبعث|ابعثلي|أبعثلي|ابي|أبي|ابغى|أبغى)\s*(?:لي\s+)?(?:ال)?(?:موقع|عنوان)(?:ه|ها|كم|ك)?)",
        ...
        r"\bbranches\b",
        r"(خرايط|الخرائط|خريطة|على الخريطة|رابط الخريطة|رابط الخرايط|رابط اللوكيشن)",
        # English / mixed
...
_register(RuleSet(
    ...
    patterns=[
        r"طلباتي السابقة كم",
        r"طلباتي\s*السابقة\s*عند(?:كم|ك|نا)\s*[\?؟]?",
        r"^\s*طلباتي\s*السابقة\s*[\?؟]?\s*$",
        r"طلباتي\s*عند(?:كم|ك|نا)\s*[\?؟]?",
        r"كم طلب لي",
        r"كم طلب عندي",
        r"عندي طلبات سابقة",
        r"كم طلب مسجل",
...
_register(RuleSet(
    ...
    patterns=[
        ...
        r"(تتبع الطلب|متى يوصل طلبي|رقم الطلب|حالة الطلب)",
        r"(الشحنة وينها|وين الشحنة|فين الشحنة)",
        r"(طلبت(?:\s+طلب)?).{0,40}(?:متى\s*(?:يوصل|توصل|يجي)|(?:وين|فين)\s*(?:طلب|الشحن)|حالة\s*(?:ال)?طلب|اب(?:ي|غى|غي)\s*اعرف\s*متى)",
