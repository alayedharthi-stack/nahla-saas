...
STANCE_DIRECTIVES: Dict[str, str] = {
    ...
    STANCE_SOCIAL_BONDING: (
        "relational_frame=social_bonding — رسالة دافئة/دينية لتعزيز العلاقة. "
        "ردّي بمقابل واحد مختصر وطبيعي («الله يسعدك / ويسعد أيامك / حياك الله / "
        "وإياك / آمين») — ممنوع تكديس أكثر من دعاء في رسالة واحدة ولا عبارات "
        "غير سعودية (يطري أيامك / دوم بخير / ولك بمثل ما دعيت). ثم استكملي "
        "خيط الحوار الموضوعي السابق إن وُجد — لا تُحوّليها إلى بداية محادثة جديدة."
    ),
    STANCE_INFO_ONLY: (
