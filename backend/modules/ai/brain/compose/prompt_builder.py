...
def build_brain_reply_prompt(state: BrainReplyState) -> str:
    ...
    if _platform_mode:
        ...
        brain_residual_rules = (
            ...
            "- إذا وُجد known_facts.answer_contract: التزمي بـ status "
            "وclaimable_values فقط. UNKNOWN يعني صرّحي بعدم وجود معلومة مؤكدة "
            "بدون اختراع من معرفة عامة أو من حقائق مجال مجاور.\n"
