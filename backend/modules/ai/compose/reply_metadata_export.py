...
BRAIN_REPLY_METADATA_EXPORT_KEYS: Tuple[str, ...] = (
    *REQUIRED_REPLY_METADATA_KEYS,
    ...
    "availability_claim_blocked",
    "availability_guard_reason",
    "catalog_claim_verification_status",
    "catalog_claim_reverification_status",
    "catalog_claim_verification_unresolved",
    "catalog_reply_withheld",
    "availability_guard_recompose_count",
    "catalog_capability",
    "catalog_request_status",
    "product_claim_stripped",
    "product_claim_blocked",
