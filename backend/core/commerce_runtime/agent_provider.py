...
REPLY_TOOL_DESCRIPTION = (
    ...
    "looked up this turn: a tappable selector whose rows show each product's short "
    "name, current price and a few of its options, or a single product card with its "
    ...
    "properties": {
        ...
        "choices": {
            ...
            "description": (
                ...
                "products this turn's search returned to choose from; for one product, a "
                "recommendation or a question it is optional. The selector is an addition over "
        ...
        "card": {
            ...
            "description": (
                ...
                "link. A card needs an https photo and an https page link in those records, "
                "and your button_label; without them no card is shown and the text is all the "
