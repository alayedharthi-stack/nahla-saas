...
_MARKER_PROTOCOL_PREAMBLE = (
    ...
    "\n"
    "⚠️ منطقة تعليمات داخلية: الأمثلة أدناه هيكل فقط — **ممنوع** نسخ "
    "الأرقام أو الأسماء حرفياً. استخدمي **فقط** بيانات التحويل من قسم "
    "المعرفة/البنك في السياق (حساب التاجر الرسمي).\n"
    "\n"
    "أمثلة (هيكل — لا تنسخي القيم):\n"
    "- العميل: «أرسل رقم الراجحي»\n"
    "  الرد:\n"
    "  [MEDIA_KEY:payment_rajhi_barcode]\n"
    "  {BANK_LABEL}\n"
    "  {TRANSFER_PHONE}\n"
    "  اسم: {BENEFICIARY_NAME}\n"
    "\n"
    "- العميل: «STC Pay»\n"
    "  الرد:\n"
    "  [MEDIA_KEY:payment_stcpay_qr]\n"
    "  {BANK_LABEL}: {TRANSFER_PHONE}\n"
    "\n"
