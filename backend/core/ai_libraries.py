...
_MARKER_PROTOCOL_PREAMBLE = (
    ...
    "- لا تكتبي رابطًا أو صورة كنص — استخدمي الـ marker فقط.\n"
    "- الـ marker دائمًا في أول الرد، قبل أي نص.\n"
)
