...
_SERVICE_CLOSER_MARKERS: Tuple[str, ...] = (
    ...
    # Do NOT use bare "تواصل معنا" / "للتواصل معنا" — they substring-match
    # legitimate merchant contact delivery ("تقدر تتواصل معنا عبر: …",
    # "للتواصل معنا عبر: …email/url…").
    "يرجى التواصل معنا",
    "للتواصل معنا عند الحاجه",
    "للتواصل معنا عند الحاجة",
    "للتواصل معنا اذا احتجت",
    "للتواصل معنا إذا احتجت",
    "تواصل معنا للمساعده",
    "تواصل معنا للمساعدة",
    "تواصل معنا اذا احتجت",
    "تواصل معنا إذا احتجت",
)
