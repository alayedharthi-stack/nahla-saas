...
Seeds the minimal valid tuple for later Layer 0 shadow observation. Does not
enable shadow flags, compose, canary, or customer messaging. Dry-run default.
...
from services.customer_conditional_coupon_shadow_fixture import (  # noqa: E402
    execute_customer_conditional_coupon_shadow_fixture_cleanup,
    execute_customer_conditional_coupon_shadow_fixture_seed,
)
from services.customer_conditional_coupon_shadow_fixture_contract import (  # noqa: E402
