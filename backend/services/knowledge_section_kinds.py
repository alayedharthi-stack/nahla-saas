...
REGISTRY: List[SectionKind] = [
    ...
    SectionKind(
        "refund_policy", 3,
        "سياسة الاسترداد",
        "شروط استرداد المبلغ والمدد والطريقة.",
    ),
    SectionKind(
        "exchange_policy", 3,
        "سياسة الاستبدال",
        "شروط الاستبدال والمدد والطريقة.",
    ),
    SectionKind(
        "terms_policy", 3,
        "الشروط والأحكام",
        "شروط استخدام المتجر وأحكام البيع.",
    ),
    SectionKind(
        "privacy_policy", 3,
        "سياسة الخصوصية",
        "كيف تُجمع البيانات وتُستخدم وتُحفظ.",
    ),
    SectionKind(
        "warranty", 3,
        "الضمان",
    ...
    SectionKind(
        "shipping_policy", 4,
        "سياسة الشحن",
        "نص سياسة الشحن/التوصيل الطويل (ليس قائمة الشركات المفعّلة).",
    ),
    SectionKind(
        "shipping_carrier", 4,
        "شركات الشحن",
