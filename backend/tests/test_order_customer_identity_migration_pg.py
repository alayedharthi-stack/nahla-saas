...
def test_migration_chain_0086_seed_0087_target_repository_0094_head(
    ...
    # Ephemeral DB stops at A1-Expand 0087; integration bootstrap pins 0093, head is 0094.
    assert "0094" in heads
