...
def test_repository_parallel_heads_0092_and_0095() -> None:
    assert REPOSITORY_ALEMBIC_HEADS == frozenset({"0092", "0095"})
...
def test_migration_0094_extends_integration_branch_from_0093() -> None:
    ...
    assert set(script.get_heads()) == frozenset({"0092", "0095"})
