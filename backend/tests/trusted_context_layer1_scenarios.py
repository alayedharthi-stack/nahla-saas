...
SCENARIOS: list[Layer1Scenario] = [
    ...
    Layer1Scenario(
        "A11", "A", "arabic_plural_offers_lazy_load_defect",
        inbound_text="في عروض حالياً؟",
        expected_lazy_load=True,
        runtime_defect="OFFERS_AR_PLURAL",
    ),
...
RUNTIME_DEFECTS = {
    "OFFERS_AR_PLURAL": {
        "scenario_id": "A11",
        "inbound_text": "في عروض حالياً؟",
        "observed_behavior": "should_load_coupon_promotion_facts() returns False",
        "expected_behavior": "True — colloquial Arabic plural offer wording should trigger coupon/promotion lazy loading",
        "responsible_function": "should_load_coupon_promotion_facts",
        "responsible_file": "backend/modules/ai/brain/truth_surface/coupon_offer_loader.py",
        "minimal_proposed_fix": "Extend _COUPON_OFFER_PATTERNS to include colloquial plural عروض (e.g. r\"عروض\") without weakening tenant isolation or adding phrase bans elsewhere.",
    },
}
