...
| Everything above satisfied for every suite | exit **0**, `PROVEN (119/119 required tests passed: 117/117 proofs + 2/2 runner/fixture regressions, 0 skips tolerated)` at the current inventory |
