...
| Everything above satisfied for every suite | exit **0**, `PROVEN (141/141 required tests passed: 139/139 proofs + 2/2 runner/fixture regressions, 0 skips tolerated)` at the current inventory |
